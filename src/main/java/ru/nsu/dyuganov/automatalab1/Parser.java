...
public class Parser {
    ...
    public void parseN(HashSet<Character> N) {
        String str;
        while (true) {
            boolean flag = false;
            System.out.print("N = ");
    ...
    public void parseT(HashSet<Character> N, HashSet<Character> T) {
        String str;
        while (true) {
            boolean flag = false;
            boolean flag1 = false;
    ...
    public void parseP(HashSet<Character> N, HashSet<Character> T, Multimap<Character, char[]> P) {
        String str;
        while (true) {
            boolean flag = false;
            System.out.print("P = ");
    ...
    public Character parseS(HashSet<Character> N, Multimap<Character, char[]> P) {
        String str;
        while (true) {
            System.out.print("S = ");
            str = scanner.nextLine();
